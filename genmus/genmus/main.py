...
s_list = ["G3", "D3", "G3", "F3", "C3", "C4", "F3", "F3", "C3", "F3", "F3", "F3", "C3", "D3", "E3", "C3", "D3", "F3", "F3", "F3", "C3", "G3", "D3", "F3", "C3", "F3", "F3", "F3", "C3", "C3", "C3", "C3", "D3", "F3", "F3", "F3", "C3", "F3", "F3", "F3", "C3", "F3", "F3", "D3", "D3", "C3", "E3", "D3", "G3", "F3", "C3", "C4", "F3", "F3", "C3", "F3", "F3", "F3", "C3", "D3", "E3", "C3", "D3", "F3", "F3", "F3", "C3", "G3", "D3", "F3", "C3", "F3", "F3", "F3", "C3", "C3", "C3", "C3", "D3", "F3", "F3", "F3", "C3", "F3", "F3", "F3", "C3", "F3", "F3", "D3", "D3", "C3", "C4"]


sd_list = [0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 1]
...
def getArguments2(bighelp: bool=False, opt: str = ""):
	...
	if opt.lower() == "t": # twinkle, twinkle, little star demo.
		# print(i)
		names_list = ["twinkle_star.wav","twinkle_star_left.wav","twinkle_star_right.wav"]
		gh.makeMusicDemo(names_list, left_hand_notes, left_hand_duration, right_hand_notes, right_hand_duration)
		exit()
...
def begin(fastaFile_str):
	...
	freq_dic = gh.getWordCartesianProducts(["A","T","C","G"],3) # get the permutations of length 3 of ATGC words
	...
	# for i in freq_dic:
		...
		this_dic = gh.getWordFreq(seq_dic[i], freq_dic) # get the word counts from this seq.
		...
		noteParing_dic = gh.pairMusicWordWithNote(this_dic, sNotes_list) # Pair the highest word frequencies with most common piano notes
		scaleNotes_list, scaleDuration_list = gh.sequenceSlidingWindow(seq_dic[i], noteParing_dic) # slide through the sequence, read words, then prepare a list of notes to play.
